...
!function(t,e){"use strict";function n(t,e){t[d]=e}function i(){var t=new Date,e=t.getMinutes();e=10>e?"0"+e:e;var n=t.getSeconds();return n=10>n?"0"+n:n,[t.getHours(),e,n].join(":")}var o=t.ID={};o.modules={};var r;docReady(function(){r=document.querySelector("#notification"),e(".js-radio-button-group").radioButtonGroup(),e("[data-js-module]").each(function(t,e){var n=e.getAttribute("data-js-module"),i=o.modules[n];i&&i(e)});var t=document.querySelector(".refactor-shirt h3"),i=new Date(2015,9,28),a=Math.round((i-new Date)/864e5);n(t,"Refactor shirts. Only on sale for "+a+" more days.")}),o.getItemElement=function(){var t=document.createElement("div"),e=Math.random(),n=Math.random(),i=e>.8?"grid-item--width3":e>.6?"grid-item--width2":"",o=n>.8?"grid-item--height3":n>.5?"grid-item--height2":"";return t.className="grid-item "+i+" "+o,t};var a,s=document.documentElement,d=void 0!==s.textContent?"textContent":"innerText",c=getStyleProperty("transition"),u=c?1e3:1500;o.notify=function(t){n(r,t+" at "+i()),c&&(r.style[c]="none"),r.style.display="block",r.style.opacity="1",a&&clearTimeout(a),a=setTimeout(o.hideNotify,u)},o.hideNotify=function(){c?(r.style[c]="opacity 1.0s",r.style.opacity="0"):r.style.display="none"},e.fn.radioButtonGroup=function(){return this.each(function(t,n){var i=e(n);i.find(":checked").parent().addClass("is-checked"),i.on("click","input, button",function(){i.find(".is-checked").removeClass("is-checked");var t=e(this),n=t.hasClass("button")?t:t.parents(".button");n.addClass("is-checked")})}),this},hljs.configure({classPrefix:""}),e.fn.displayIsotopeCode=function(t,e){e="string"==typeof e&&-1===e.indexOf("function")?"'"+e+"'":e;var n="$grid.isotope({ "+t+": "+e+" })";n=hljs.highlight("js",n).value,this.html(n)}}(window,jQuery);
...
ID.modules["filtering-demo"]=function(t){"use strict";var n=$(t),e=n.find(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",transitionDuration:"0.6s"}),i={numberGreaterThan50:function(){var t=$(this).find(".number").text();  
return parseInt(t,10)>50},ium:function(){var t=$(this).find(".name").text();return t.match(/ium$/)}},r={numberGreaterThan50:"function() {\n  var number = $(this).find('.number').text();\n  return parseInt( number, 10 ) > 50;\n}",ium:"function() {\n  var name = $(this).find('.name').text();\n  return name.match( /ium$/ );\n}"},o=n.find(".code-display code");n.find(".filter-button-group").on("click","button",function(){var t=$(this).attr("data-filter"),n=i[t]||t,u=r[t]||t;e.isotope({filter:n}),o.displayIsotopeCode("filter",u)})};

                


ID.modules["hero-demo"]=function(t){"use strict";var e=$(t),n=e.find(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",transitionDuration:"0.6s",getSortData:{name:".name",symbol:".symbol",date : ".date", number:".number parseInt",category:"[data-category]",weight:function(t){var e=$(t).find(".weight").text();return parseFloat(e.replace(/[\(\)]/g,""))}}}),r={numberGreaterThan50:function(){var t=$(this).find(".number").text();return parseInt(t,10)>50},ium:function(){var t=$(this).find(".name").text();return t.match(/ium$/)}},i={numberGreaterThan50:"function() {\n  var number = $(this).find('.number').text();\n  return parseInt( number, 10 ) > 50;\n}",ium:"function() {\n  var name = $(this).find('.name').text();\n  return name.match( /ium$/ );\n}"},o=e.find(".code-display code");e.find(".sort-by").on("click","button",function(){var t=$(this).attr("data-sort-by");n.isotope({sortBy:t}),o.displayIsotopeCode("sortBy",t)}),e.find(".filters").on("click","button",function(){var t=$(this).attr("data-filter"),e=r[t]||t,a=i[t]||t;n.isotope({filter:e}),o.displayIsotopeCode("filter",a)})};
...
ID.modules["sorting-demo"]=function(t){"use strict";var o=$(t),e=o.find(".sort-by-button-group"),r=o.find(".grid").isotope({itemSelector:".element-item",layoutMode:"fitRows",transitionDuration:"0.6s",getSortData:{name:".name",symbol:".symbol",number:".number parseInt",date :".date", category:"[data-category]",weight:function(t){var o=$(t).find(".weight").text();return parseFloat(o.replace(/[\(\)]/g,""))}}}),i=o.find(".code-display code");e.on("click","button",function(){var t=$(this).attr("data-sort-by");r.isotope({sortBy:t}),i.displayIsotopeCode("sortBy",t)})};
...
ID.modules["vertical-list"]=function(t){"use strict";var e=$(t),o=e.find(".vertical-list").isotope({itemSelector:"li",layoutMode:"vertical",transitionDuration:"0.6s",getSortData:{name:".name",symbol:".symbol",number:".number parseInt", date: ".date", category:".category",weight:function(t){var e=$(t).find(".weight").text();return parseFloat(e.replace(/[\(\)]/g,""))}}});e.find(".button-group").on("click","button",function(){var t=$(this).attr("data-sort-by");o.isotope({sortBy:t})})};